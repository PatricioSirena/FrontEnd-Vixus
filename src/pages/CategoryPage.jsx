    ...
    useEffect(() => {
        const getCategoryProducts = async () => {
            ...
            try {
                ...
                const productsOfCategory = activeProducts.filter(product => product.categories.some(category => category === params.categoryName.toLowerCase()))
                const otherProducts = activeProducts.filter(product => !product.categories.some(category => category === params.categoryName.toLowerCase()))
